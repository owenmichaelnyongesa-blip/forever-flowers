...
function renderProducts(list) {
  ...
  list.forEach(p => {
    ...
    const msg = `Hello, I'm interested in ${p.name}. Is it available? 🌸`;
    ...
    card.innerHTML = `
      <div class="product-img-wrap">
        <img src="${p.image}" alt="${p.name}" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1487530811015-780780169993?w=600&q=80'"/>
        ${badge}
      ...
      <div class="product-info">
        ...
        <button class="btn-inquire" onclick="window.open('${waLink(msg)}','_blank')">
